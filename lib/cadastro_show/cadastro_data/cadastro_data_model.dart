...
import 'cadastro_data_widget.dart' show CadastroDataWidget;
import 'package:flutter/material.dart';

class CadastroDataModel extends FlutterFlowModel<CadastroDataWidget> {
  ///  Local state fields for this component.

  DateTime? selectTipoData;
  ...
  DocumentReference? selectTipoReferencia;
  ...
  List<DataRecord> datasJaCriada = [];
  void addToDatasJaCriada(DataRecord item) => datasJaCriada.add(item);
  void removeFromDatasJaCriada(DataRecord item) => datasJaCriada.remove(item);
  void removeAtIndexFromDatasJaCriada(int index) =>
      datasJaCriada.removeAt(index);
  void insertAtIndexInDatasJaCriada(int index, DataRecord item) =>
      datasJaCriada.insert(index, item);
  void updateDatasJaCriadaAtIndex(int index, Function(DataRecord) updateFn) =>
      datasJaCriada[index] = updateFn(datasJaCriada[index]);
