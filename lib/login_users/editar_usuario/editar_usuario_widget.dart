...
import '/login_users/add_local_user/add_local_user_widget.dart';
...
class EditarUsuarioWidget extends StatefulWidget {
  ...
  static String routeName = 'editar-usuario';
...
class _EditarUsuarioWidgetState extends State<EditarUsuarioWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'editar-usuario'});
                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: StreamBuilder<UsersRecord>(
                                  stream:
                                      UsersRecord.getDocument(widget.user!),
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'EDITAR_USUARIO_NOVO_LOCAL_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_bottom_sheet');
                                                                      ...
                                                                      if (valueOrDefault(
                                                                        ...
                                                                        AuthUserStreamWidget(
                                                                          builder: (context) =>
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('EDITAR_USUARIO_PAGE_Icon_h83wdfjl_ON_TAP');
                                                                              logFirebaseEvent('Icon_backend_call');

                                                                              await columnLocalRecord.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                                                                              ...
                                                                              await containerUsersRecord.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                                                                                    'locais': FieldValue.arrayRemove([
                                                                                      columnLocalRecord.reference.id
                                                                                    ]),
                                                                                  },
                                                                                ),
                                                                              });
                                                    ...
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'EDITAR_USUARIO_EDITAR_CONTA_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_backend_call');
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'EDITAR_USUARIO_arrow_back_rounded_ICN_ON');
                                                    logFirebaseEvent(
                                                ...
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'EDITAR_USUARIO_menu_rounded_ICN_ON_TAP');
                                                    logFirebaseEvent(
                                                                    ...
                                                                    if (valueOrDefault(
                                                                      ...
                                                                      AuthUserStreamWidget(
                                                                        builder:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('EDITAR_USUARIO_PAGE_Icon_ezog5ie1_ON_TAP');
                                                                            logFirebaseEvent('Icon_backend_call');
                            ...
                            if (_model.abrirMenu)
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'EDITAR_USUARIO_menu_open_rounded_ICN_ON_');
                                    logFirebaseEvent(
                                        'IconButton_update_page_state');
