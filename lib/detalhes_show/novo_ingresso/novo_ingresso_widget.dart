...
import 'novo_ingresso_model.dart';
export 'novo_ingresso_model.dart';

class NovoIngressoWidget extends StatefulWidget {
  const NovoIngressoWidget({
    super.key,
    required this.data,
  });
  ...
  @override
  State<NovoIngressoWidget> createState() => _NovoIngressoWidgetState();
}

class _NovoIngressoWidgetState extends State<NovoIngressoWidget> {
  late NovoIngressoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovoIngressoModel());
    ...
    _model.textFieldvalidTextController ??= TextEditingController();
    _model.textFieldvalidFocusNode ??= FocusNode();

    _model.textFieldcupommTextController ??= TextEditingController();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textFieldvalidTextController?.text = '1';
        }));
  }
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'NOVO_INGRESSO_COMP_Icon_mwsdx6o8_ON_TAP');
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Stack(
                      children: [
                        TextFormField(
                          controller: _model.textFieldvalidTextController,
                          focusNode: _model.textFieldvalidFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'NOVO_INGRESSO_COMP_Icon_5p2d0xi9_ON_TAP');
                      ...
                      Theme(
                        ...
                        child: Checkbox(
                          ...
                          onChanged: (newValue) async {
                            ...
                            if (!newValue!) {
                              logFirebaseEvent(
                                  'NOVO_INGRESSO_Checkbox_duspo71z_ON_TOGGL');
                              logFirebaseEvent(
                  ...
                  if (_model.checkboxValue ?? true)
                    Expanded(
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'NOVO_INGRESSO_Container_9rpgh395_ON_TAP');
                          ...
                          _model.finalizacao = _model.datePicked;
                          safeSetState(() {});
                        },
                        child: Container(
                          decoration: BoxDecoration(
              ...
              Row(
                ...
                children: [
                  Theme(
                    ...
                    child: Checkbox(
                      value: _model.checkboxCupomValue ??= false,
                      onChanged: (newValue) async {
                        safeSetState(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.textFieldcupommTextController,
                      ...
                      Container(
                        width: 150.0,
                        child: TextFormField(
                          controller: _model.textFieldQuantCupomTextController,
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('NOVO_INGRESSO_COMP_CRIAR_BTN_ON_TAP');
                    if (_model.checkboxCupomValue!) {
                      ...
                      await ingressoRecordReference1
                        ...
                        quantidade: int.tryParse(_model.textController5.text),
                        valorSemTaxa:
                        ...
                        data: widget.data?.reference,
                        dataCriacao: getCurrentTimestamp,
                        show: widget.data?.show,
                        ...
                        validoQuantasPessoas: int.tryParse(
                            _model.textFieldvalidTextController.text),
                        finalizacaoVenda: _model.finalizacao,
                      ));
                      _model.newIngressocupom =
                      ...
                      await CupomRecord.collection
                          ...
                          .set(createCupomRecordData(
                            nome: _model.textFieldcupommTextController.text,
                            tipo: _model.dropDownValue,
                            quantidade:
                                int.tryParse(_model.textController5.text),
                            data: widget.data?.reference,
                            valor: double.tryParse(
                                _model.textFieldValorCupomTextController.text),
                            show: widget.data?.show,
                            ingresso: _model.newIngressocupom?.reference,
                            quantidadeRestante: int.tryParse(
                                _model.textFieldQuantCupomTextController.text),
                          ));
                      logFirebaseEvent('Button_backend_call');
                        ...
                        ...mapToFirestore(
                          {
                            'ingressos': FieldValue.arrayUnion(
                                [_model.newIngressocupom?.reference]),
                          },
                        ),
                      });
                    } else {
                      ...
                      _model.newIngresso = IngressoRecord.getDocumentFromData(
                          createIngressoRecordData(
                            nome: _model.textController1.text,
                            quantidade:
                                int.tryParse(_model.textController5.text),
