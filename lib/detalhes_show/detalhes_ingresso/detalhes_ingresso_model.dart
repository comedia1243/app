...
import 'detalhes_ingresso_widget.dart' show DetalhesIngressoWidget;
import 'package:flutter/material.dart';

class DetalhesIngressoModel extends FlutterFlowModel<DetalhesIngressoWidget> {
  ...
  IngressoRecord? ingress;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  IngressoRecord? ingressoDuplica;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  CupomRecord? cupomm;
