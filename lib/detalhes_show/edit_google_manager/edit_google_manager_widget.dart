...
import 'edit_google_manager_model.dart';
export 'edit_google_manager_model.dart';

class EditGoogleManagerWidget extends StatefulWidget {
  const EditGoogleManagerWidget({
    super.key,
    required this.show,
  ...
  @override
  State<EditGoogleManagerWidget> createState() =>
      _EditGoogleManagerWidgetState();
}

class _EditGoogleManagerWidgetState extends State<EditGoogleManagerWidget> {
  late EditGoogleManagerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditGoogleManagerModel());
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'EDIT_GOOGLE_MANAGER_Icon_snb3wxk6_ON_TAP');
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDIT_GOOGLE_MANAGER_CANCELAR_BTN_ON_TAP');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'EDIT_GOOGLE_MANAGER_SALVAR_CONFIGURAES_B');
