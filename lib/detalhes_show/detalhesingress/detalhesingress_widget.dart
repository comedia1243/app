...
import 'detalhesingress_model.dart';
export 'detalhesingress_model.dart';

class DetalhesingressWidget extends StatefulWidget {
  const DetalhesingressWidget({
    super.key,
  ...
  static String routeName = 'detalhesingress';
  static String routePath = 'detalhesingress';

  @override
  State<DetalhesingressWidget> createState() => _DetalhesingressWidgetState();
}

class _DetalhesingressWidgetState extends State<DetalhesingressWidget> {
  late DetalhesingressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesingressModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'detalhesingress'});
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DETALHESINGRESS_Icon_g986u8bo_ON_TAP');
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'DETALHESINGRESS_Icon_zpeqlptg_ON_TAP');
                                                logFirebaseEvent(
                                                    'Icon_alert_dialog');
                                                await showDialog(
                                                  context: context,
                                      ...
                                      Theme(
                                        ...
                                        child: Checkbox(
                                          ...
                                          onChanged: (newValue) async {
                                            ...
                                            if (!newValue!) {
                                              logFirebaseEvent(
                                                  'DETALHESINGRESS_Checkbox_xqc0912g_ON_TOG');
                                              logFirebaseEvent(
                              ...
                              if (_model.checkboxValue ?? true)
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DETALHESINGRESS_Container_k5n8iajl_ON_TA');
                                      logFirebaseEvent(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DETALHESINGRESS_PAGE_OCULTAR_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DETALHESINGRESS_SUSPENDER_VENDA_BTN_ON_T');
                                  if ((containerIngressoRecord
                                              .quantidadeRestante ==
                                          0) &&
                                    ...
                                    await containerIngressoRecord.reference
                                        .update(createIngressoRecordData(
                                      suspender: containerIngressoRecord
                                          .quantidadeRestante,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DETALHESINGRESS_DUPLICAR_INGRESSO_BTN_ON');
                                  logFirebaseEvent('Button_backend_call');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DETALHESINGRESS_SALVAR_ALTERAES_BTN_ON_T');
                                  logFirebaseEvent('Button_backend_call');
                              ...
                              Container(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'DETALHESINGRESS_PAGE_DELETAR_BTN_ON_TAP');
                                    logFirebaseEvent('Button_bottom_sheet');
                                    Navigator.pop(context);
                                    logFirebaseEvent('Button_bottom_sheet');
