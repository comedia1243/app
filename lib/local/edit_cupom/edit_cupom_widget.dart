...
import 'edit_cupom_model.dart';
export 'edit_cupom_model.dart';

class EditCupomWidget extends StatefulWidget {
  const EditCupomWidget({
    super.key,
    required this.cupom,
  });
  ...
  @override
  State<EditCupomWidget> createState() => _EditCupomWidgetState();
}

class _EditCupomWidgetState extends State<EditCupomWidget> {
  late EditCupomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCupomModel());

    _model.textController1 ??= TextEditingController(text: widget.cupom?.nome);
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EDIT_CUPOM_COMP_Icon_iucmiwm4_ON_TAP');
                        ...
                        Expanded(
                          child: FlutterFlowDropDown<String>(
                            controller: _model.dropDownValueController ??=
                              ...
                              _model.dropDownValue ??= widget.cupom?.tipo,
                            ),
                      ...
                      child: Visibility(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: widget.cupom?.valor.toString(),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('EDIT_CUPOM_COMP_SALVAR_BTN_ON_TAP');
