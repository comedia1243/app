                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADD_BANNER_COMP_Icon_fd5rxhuo_ON_TAP');
                  ...
                  children: [
                    if (_model.foto == null || _model.foto == '')
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'ADD_BANNER_Container_9fg4b138_ON_TAP');
                          logFirebaseEvent(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ADD_BANNER_COMP_Icon_85ag0y8v_ON_TAP');
                                  logFirebaseEvent(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ADD_BANNER_COMP_Icon_urfmjz67_ON_TAP');
                                  logFirebaseEvent(
                                      'Icon_update_component_state');
                    ...
                    if (_model.fotoGrande == null || _model.fotoGrande == '')
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'ADD_BANNER_Container_jb8u8yke_ON_TAP');
                          logFirebaseEvent(
                              'Container_upload_media_to_firebase');
                          final selectedMedia = await selectMedia(
                            mediaSource: MediaSource.photoGallery,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('ADD_BANNER_COMP_SALVAR_BTN_ON_TAP');
                          ...
                          await BannersRecord.collection
                              ...
                              .set(createBannersRecordData(
                                ...
                                imgGrand: _model.uploadedFileUrl2,
                              ));
